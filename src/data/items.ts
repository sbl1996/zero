...
const baseItems: ItemDefinition[] = [
  { id: 'potionHP', name: '生命药水Ⅰ', heal: 100, price: 50, description: '回复100点生命值' },
  { id: 'potionQi', name: '斗气药水Ⅰ', restoreQi: 100, price: 120, description: '回复100点斗气' },
  { id: 'potionQiPlus', name: '斗气药水Ⅱ', restoreQi: 200, price: 240, description: '回复200点斗气' },
